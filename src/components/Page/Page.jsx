...
const Page = () => {
    return (
        ...
        <section className="bg-white p-10 gap-6 flex flex-col rounded-lg lg:w-1/2 justify-center lg:rounded-l-none">
            ...
            <form>
                <label className="text-sm text-gray-700 mb-2" for="email">Email</label>
                <input className="text-sm w-full mb-4 pl-3 rounded border py-2 shadow focus:outline-none hover:border-azul-claro hover:ring-1 hover:ring-azul-escuro focus:border-azul-escuro focus:ring-1 focus:ring-azul-escuro"  id="email" type="email" placeholder="Digite seu endereço de email"/>                    
